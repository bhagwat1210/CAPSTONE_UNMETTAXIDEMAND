...
## Segregrate data in supply for wheel chair vehicle i.e breadcrumb into occupied(1) and free minute(0) by comparing it
## with the triprecord(observed demand) data for both vts and lpep. 
...
if __name__=='__main__':
  ...
  #trips = sc.textFile(','.join(sys.argv[1:-2]))
  dat = sc.textFile('tpep_wav_triprecord_total.csv')
  dat_b = sc.textFile('tpep_wav_breadcrumb_total.csv')
